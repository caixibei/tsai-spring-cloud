...
-- 接入应用信息
INSERT INTO `oauth_client_details` VALUES ('spring-cloud-system', 'spring-cloud-system', '$2a$10$mcEwJ8qqhk2DYIle6VfhEOZHRdDbCSizAQbIwBR7tTuv9Q7Fca9Gi', 'all', 'authorization_code,password,refresh_token', 'http://localhost:7080/login',NULL,300,3600,NULL,'all');
-- 创建用户信息表
